...
export class cc1Wallet extends Component {
    ...
    handleClick = () => {
        ...
        this.props.exportModal(true, data.cc3Transactions)
    }
            ...
            <Row>
                ...
                <Card bg="dark" text="white" border="info">
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>£{cc3.getCurrentPrice().toFixed(2)}</Card.Text>
                    </Card.Body>
                </Card>
                <br></br>
                <Card bg="dark" text="white" border="info">
                ...
                <Card bg="dark" text="white" border="info"><Card.Body className="messagingTitle">Wallet History - Last 10 Transactions</Card.Body></Card> 
                    <br></br>
                    {data.cc3Transactions && data.cc3Transactions.slice(0,10).map(item => {
                        return(
